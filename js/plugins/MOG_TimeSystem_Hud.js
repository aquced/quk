...
SpriteTimeEngine.prototype.loadImages = function() {
    Sprite.prototype.initialize.call(this);
    this._layout_img = ImageManager.loadSystem(Moghunter.src_TimeHud_A);
	this._pont1_img = ImageManager.loadSystem(Moghunter.src_TimeHud_B);
	this._pont2_img = ImageManager.loadSystem(Moghunter.src_TimeHud_C);
	if (Moghunter.timehud_phase_visible === "true") {this._phase_img = ImageManager.loadSystem(Moghunter.src_TimeHud_D)};
	if (Moghunter.timehud_season_visible === "true") {this._season_img = ImageManager.loadSystem(Moghunter.src_TimeHud_E)};
};
