...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_EnemyPoses');
	...
	for (Moghunter.i = 1; Moghunter.i <= Moghunter.poses_list_length ; ++Moghunter.i) {
	  Moghunter.line = "String(Moghunter.parameters['敌人-" + Moghunter.i + "-姿势'] )";
	  Moghunter.poses_list[Moghunter.i] = eval(Moghunter.line);
	  Moghunter.line = "String(Moghunter.parameters['SV敌人-" + Moghunter.i + "-姿势'] )";
	  Moghunter.poses_sv_list[Moghunter.i] = eval(Moghunter.line);
	};
...
Game_Enemy.prototype.transform = function(enemyId) {
	...
	this._batPoses = [false,0,0,-1,false];
	//enmynotes.forEach(function(note) {if (note === "Battler Poses"){this._batPoses[0] = true;};},this);
};
