...
Actor_Hud.prototype.initialize = function(hud_id) {
	...
	$gameSystem._hPoint = $gameSystem._hPoint || 0;
	this.update();
};
...
Actor_Hud.prototype.need_refresh_parameter = function(parameter) {
  switch (parameter) {
  	case 0:
         ...
         break;
  	case 1:
         if (this._mp_old[0] != $gameSystem._hPoint) {return true};
		 if (this._mp_old[1] != Nnfs._tensionPointMax) {return true};
         break;			
  	case 2:
         if (this._tp_old[0] != this._battler.trunk()) {return true};		 
		 if (this._tp_old[1] != Imported.Trunk._max) {return true};
         break;	
  	case 3:
...
Actor_Hud.prototype.create_mp_meter = function() {
	...
	this._mp_old_ani[0] = $gameSystem._hPoint - 1;
...
Actor_Hud.prototype.create_mp_number = function() {
	...
	this._mp_number_old = $gameSystem._hPoint;
...
Actor_Hud.prototype.create_maxmp_number = function() {
	...
	this._maxmp_number_old = Nnfs._tensionPointMax;	
...
Actor_Hud.prototype.update_mp = function() {
	const mp = $gameSystem._hPoint;
	const mmp = Nnfs._tensionPointMax;
	if (this._mp_meter_blue) {
		if(this._mp_flow[0]) {
		   if (this._mp_old[1] != mmp) {
		       this._mp_old = [mp,mmp];
			   this.refresh_meter_flow(this._mp_meter_red,mp,mmp,1,$gameSystem._ahud_flowData[1]);
		   };			
		   this.refresh_meter_flow(this._mp_meter_blue,mp,mmp,0,$gameSystem._ahud_flowData[1]);
	   	   var dif_meter = this.update_dif(this._mp_old_ani[0],mp,160);
		   if (this._mp_old_ani[0] != dif_meter) {this._mp_old_ani[0] = dif_meter;
	       this.refresh_meter_flow(this._mp_meter_red,this._mp_old_ani[0],mmp,1,$gameSystem._ahud_flowData[1]);
		   };
		   ...
		   if ($gameSystem._ahud_flowData[1] > this._mp_flow[3]) {$gameSystem._ahud_flowData[1] = 0};		   
			...
			if (this.need_refresh_parameter(1)) {
				this.refresh_meter(this._mp_meter_blue,mp,mmp,0,2,0);
				this._mp_old = [mp,mmp];
			};
			var dif_meter = this.update_dif(this._mp_old_ani[0],mp,160)
			if (this._mp_old_ani[0] != dif_meter) {this._mp_old_ani[0] = dif_meter;
			this.refresh_meter(this._mp_meter_red,this._mp_old_ani[0],mmp,1,2,0);};
		};
    };
	if (this._mp_number) {
		var dif_number = this.update_dif(this._mp_number_old,mp,30)
		if (this._mp_number_old != dif_number) {this._mp_number_old = dif_number;
		this.refresh_number(this._mp_number,this._mp_number_old,this._mp_img_data,this._mp_img_data[4],0);};
	};
	if (this._maxmp_number) {
		if (this._maxmp_number_old != mmp) {this._maxmp_number_old = mmp;
		this.refresh_number(this._maxmp_number,this._maxmp_number_old,this._maxmp_img_data,this._maxmp_img_data[4],0);};
	};
	if (this._mp_icons) {
		if (this._mp_icon_old[0] != mp || this._mp_icon_old[1] != mmp) {
		    this._mp_icon_old[0] = mp;
			this._mp_icon_old[1] = mmp;
			this.refresh_icons(this._mp_iconsB,this._mp_icon_img,mp,mmp,0);
	        this.refresh_icons(this._mp_icons,this._mp_icon_img,mp,mmp,1);
		};
...
Actor_Hud.prototype.create_tp_meter = function() {
	...
	this._tp_old_ani[0] = this._battler.trunk() - 1;
...
Actor_Hud.prototype.create_tp_number = function() {
	...
	this._tp_number_old = this._battler.trunk();
...
Actor_Hud.prototype.update_tp = function() {
	const tp = this._battler.trunk();
	const mtp = Imported.Trunk._max;
	if (this._tp_meter_blue) {
		if(this._tp_flow[0]) {
		   if (this._tp_old[1] != mtp) {
		       this._tp_old = [tp,mtp];
			   this.refresh_meter_flow(this._tp_meter_red,tp,mtp,1,$gameSystem._ahud_flowData[2]);
		   };				
		   this.refresh_meter_flow(this._tp_meter_blue,tp,mtp,0,$gameSystem._ahud_flowData[2]);
	   	   var dif_meter = this.update_dif(this._tp_old_ani[0],tp,160)
		   if (this._tp_old_ani[0] != dif_meter) {this._tp_old_ani[0] = dif_meter;
	       this.refresh_meter_flow(this._tp_meter_red,this._tp_old_ani[0],mtp,1,$gameSystem._ahud_flowData[2]);
		   };
		   ...
		   if ($gameSystem._ahud_flowData[2] > this._tp_flow[3]) {$gameSystem._ahud_flowData[2] = 0};		   
			...
			if (this.need_refresh_parameter(2)) {
				this.refresh_meter(this._tp_meter_blue,tp,mtp,0,2,0);
				this._tp_old = [tp,mtp];
			};
			var dif_meter = this.update_dif(this._tp_old_ani[0],tp,160)
			if (this._tp_old_ani[0] != dif_meter) {this._tp_old_ani[0] = dif_meter;
			this.refresh_meter(this._tp_meter_red,this._tp_old_ani[0],mtp,1,2,0);};
	};
    };
	if (this._tp_number) {
		var dif_number = this.update_dif(this._tp_number_old,tp,30)
		if (this._tp_number_old != dif_number) {this._tp_number_old = dif_number;
		this.refresh_number(this._tp_number,this._tp_number_old,this._tp_img_data,this._tp_img_data[4],0);};
	};
	if (this._tp_icons) {
		if (this._tp_icon_old[0] != tp || this._tp_icon_old[1] != mtp) {
		    this._tp_icon_old[0] = tp;
			this._tp_icon_old[1] = mtp;
			this.refresh_icons(this._tp_iconsB,this._tp_icon_img,tp,mtp,0);
	        this.refresh_icons(this._tp_icons,this._tp_icon_img,tp,mtp,1);
		};
