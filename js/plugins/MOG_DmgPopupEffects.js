...
Sprite_Damage.prototype.updateDmgSpriteEffect = function(sprite) {
	switch (this._animeType)
	{
		case 0: this.updateBounceEffect(sprite); break;
		case 9: this.updateStateAttachedEffect(sprite); break;
		default: this.updateFlyEffect(sprite); break;

	}
    if (this._zoomEffect)
    	this.updateZoomEffect(sprite);
};
...
//==============================
// ** Update state popup Effect
//==============================
Sprite_Damage.prototype.updateStateAttachedEffect = function(sprite) {
	sprite.opacity += 35;
	sprite.dy *= 0.95;
	sprite.ry += sprite.dy;
	sprite.y = Math.round(sprite.ry) - sprite.yf - sprite.yf2;			
