...
BattleResult.prototype.updateExp = function() {
	 ...
	 this.refresh_number(this._expNumber,this._expOld,this._numbeData,this._expOrg[0],1)};
...
BattleResult.prototype.updateGold = function() {
	 ...
	 this.refresh_number(this._goldNumber,this._goldOld,this._numbeData,this._goldOrg[0],1)};
...
BattleResult.prototype.updateLevel = function() {
	...
	if (!this._actor && this._actorIndex >= $gameParty.allMembers().length) {
		this._phase = 5;
		SoundManager.playCursor();
	} else {
		if (this._actor) {
