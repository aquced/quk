	...
	for (var i = 0; i < this._list.length; i++) {
		 ...
		 for (var r = 0; r < this._list.length; r++) {
		 	switch (this._list[r].name) {
		 		case "攻撃": this._com_images.push(ImageManager.loadBcom("Com_Attack")); break;
		 		case "防御": this._com_images.push(ImageManager.loadBcom("Com_Guard")); break;
		 		case "アイテム": this._com_images.push(ImageManager.loadBcom("Com_Item")); break;
		 		case "入れ替え": this._com_images.push(ImageManager.loadBcom("Com_Change")); break;
		 		default:
