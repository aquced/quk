...
Game_Interpreter.prototype.setFilterInt = function(command, args) {
	if (command === "filter_effect")  { 
	    $gameSystem.clearPixiAnimation2();
	    $gameSystem._pixiFilterData = [true, Number(args[1])];
    };
	if (command === "filter_clear")  {$gameSystem.clearPixiFData2()};
...
// * clear PixiFData
//==============================
Game_System.prototype.clearPixiFData2 = function() {
...
// * clear PixiAnimation
//==============================
Game_System.prototype.clearPixiAnimation2 = function() {
