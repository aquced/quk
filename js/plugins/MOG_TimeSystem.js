...
Game_System.prototype.set_day_phase = function() {
	if (this.hour() >= 20 || this.hour() < 0) {this._time_data[1] = 3} // Night
	else if (this.hour() >= 15) {this._time_data[1] = 2} //Dusk
	else if (this.hour() >= 11) {this._time_data[1] = 0} // Sunset
	else if (this.hour() >= 9) {this._time_data[1] = 1} // Normal
	else if (this.hour() >= 6) {this._time_data[1] = 5} // Sunrise
	else if (this.hour() >= 0) {this._time_data[1] = 4} // Dawn
};
