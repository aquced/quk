...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_BattleHud');
	...
	Moghunter.bhud_space_x = Number(Moghunter.parameters['Hud Space X'] || 200);
	...
	Moghunter.bhud_face_pos_x = Number(Moghunter.parameters['Face X-Axis'] || 60);
	Moghunter.bhud_face_pos_y = Number(Moghunter.parameters['Face Y-Axis'] || 31);
	...
	Moghunter.bhud_name_pos_x = Number(Moghunter.parameters['Name X-Axis'] || 30);
	...
	Moghunter.bhud_hp_number_pos_y  = Number(Moghunter.parameters['HP Number Y-Axis'] || 18);
	...
	Moghunter.bhud_mp_meter_pos_x = Number(Moghunter.parameters['MP Meter X-Axis'] || 195);
	Moghunter.bhud_mp_meter_pos_y = Number(Moghunter.parameters['MP Meter Y-Axis'] || 39);	
	...
	Moghunter.bhud_mp_number_pos_x  = Number(Moghunter.parameters['MP Number X-Axis'] || 259);
	Moghunter.bhud_mp_number_pos_y  = Number(Moghunter.parameters['MP Number Y-Axis'] || 18);
	...
	Moghunter.bhud_tp_number_pos_x  = Number(Moghunter.parameters['TP Number X-Axis'] || 294);
	Moghunter.bhud_tp_number_pos_y  = Number(Moghunter.parameters['TP Number Y-Axis'] || 22);
    ...
    Moghunter.bhud_tp_align_type  = Number(Moghunter.parameters['TP Number Align type'] || 1);
	...
	Moghunter.bhud_at_meter_pos_x = Number(Moghunter.parameters['ATB Meter X-Axis'] || 20);
	Moghunter.bhud_at_meter_pos_y = Number(Moghunter.parameters['ATB Meter Y-Axis'] || 50);	
	...
	Moghunter.bhud_states_pos_y = Number(Moghunter.parameters['States Y-Axis'] || 10);
    ...
    // COMMAND WINDOWS
	Moghunter.bhud_auto_pos = String(Moghunter.parameters['Command Auto Adjust'] || false);
    Moghunter.bhud_com_x = Number(Moghunter.parameters['W Command X-Axis'] || 30);
    Moghunter.bhud_com_y = Number(Moghunter.parameters['W Command Y-Axis'] || 305);
